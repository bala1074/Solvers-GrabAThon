...
public class TwoFactorAuthUtil {
	 ...
	 */
	public String generateCurrentNumber(String secret) throws InvalidKeyException, NoSuchAlgorithmException {
	 ...
	 * @throws InvalidKeyException 
	 */
	public String generateCurrentNumber(String secret, long currentTimeMillis) throws NoSuchAlgorithmException, InvalidKeyException  {
